...
import {
  ...
  Activity, DollarSign, Wifi, WifiOff, GitBranch, Key, Sparkles, Terminal, ShieldAlert, AlertCircle
} from 'lucide-react';
                ...
                >
                  ...
                  {isSelected && (
                    <motion.div initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
                      <Check strokeWidth={3} size={14} style={{ color: '#10b981' }} />
                    </motion.div>
                  )}
                </button>
              );
  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: isSelected ? '0 12px 24px rgba(0,0,0,0.12)' : '0 4px 12px rgba(0,0,0,0.04)',
      }}>
        {/* Mock UI Preview */}
        <div style={{ position: 'absolute', top: 0, left: 0, width: '25%', height: '100%', background: t.surface, borderRight: `1px solid ${t.border}` }}>
           <div style={{ width: '60%', height: '4px', borderRadius: '2px', background: t.textMuted, margin: '8px auto 0' }} />
           <div style={{ width: '40%', height: '3px', borderRadius: '1.5px', background: t.textMuted, margin: '4px auto 0', opacity: 0.5 }} />
        </div>
        <div style={{ position: 'absolute', top: '15%', left: '35%', width: '50%', height: '24%', borderRadius: '6px', background: t.aiBubble, border: `1px solid ${t.border}` }} />
        <div style={{ position: 'absolute', bottom: '15%', right: '10%', width: '40%', height: '20%', borderRadius: '6px', background: t.userBubble }} />
      ...
      <div style={{ padding: '0 4px' }}>
        ...
        <div style={{ fontSize: '10px', color: 'var(--text-tertiary)' }}>{theme.description.substring(0, 30)}...</div>
      </div>
    </motion.button>
  );
};
...
const VisualOption = ({ id, label, icon: Icon, isActive, onClick, preview }) => (
  <motion.button
    whileHover={{ y: -1, background: 'var(--bg-tertiary)' }}
    whileTap={{ scale: 0.98 }}
    onClick={() => onClick(id)}
    style={{
  ...
  >
    ...
    {preview && (
      <div style={{ 
        height: '40px', width: '100%', borderRadius: '8px', 
    ...
    <div style={{ maxWidth: '640px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '40px' }}>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
          <div>
            <h3 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--text-primary)', letterSpacing: '-0.02em', margin: 0 }}>Interface Style</h3>
            <p style={{ fontSize: '13px', color: 'var(--text-tertiary)', marginTop: '4px' }}>Choose how TutorBoard feels to you.</p>
          </div>
          
          <div style={{ 
            display: 'flex', background: 'var(--bg-secondary)', borderRadius: '12px', padding: '4px',
            border: '1px solid var(--border-color)' 
          }}>
            {[
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: mode === m.id ? '0 2px 8px rgba(0,0,0,0.05)' : 'none',
      ...
      <div>
        <div style={{ marginBottom: '24px' }}>
          <h3 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--text-primary)', letterSpacing: '-0.02em', margin: 0 }}>Canvas Workspace</h3>
          <p style={{ fontSize: '13px', color: 'var(--text-tertiary)', marginTop: '4px' }}>Configure your pedagogical workbench.</p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          {/* Grid Style */}
          <div>
            <span style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'block', marginBottom: '12px' }}>Grid Texture</span>
            <div style={{ display: 'flex', gap: '12px' }}>
              <VisualOption
                id="dots" label="Precision Dots" icon={TableProperties}
                ...
                preview={
                  <div style={{ 
                    ...
                    backgroundSize: '8px 8px', opacity: 0.3 
                  }} />
                }
              />
              <VisualOption
                id="lines" label="Architectural Lines" icon={Grid3X3}
          ...
          {/* Sidebar Position */}
          <div>
            <span style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'block', marginBottom: '12px' }}>Sidebar Orientation</span>
            <div style={{ display: 'flex', gap: '12px' }}>
              <VisualOption
                id="left" label="Standard (Left)" icon={PanelLeft}
                isActive={store.layoutView === 'left'}
                onClick={store.setLayoutView}
                preview={
                  <div style={{ display: 'flex', width: '40px', height: '24px', borderRadius: '4px', border: '1px solid var(--border-color)', overflow: 'hidden' }}>
                    <div style={{ width: '30%', background: 'var(--text-primary)', opacity: 0.2 }} />
                    <div style={{ flex: 1, background: 'transparent' }} />
                  </div>
                }
              />
              <VisualOption
                id="right" label="Right Handed" icon={PanelRight}
                isActive={store.layoutView === 'right'}
                onClick={store.setLayoutView}
                preview={
                  <div style={{ display: 'flex', width: '40px', height: '24px', borderRadius: '4px', border: '1px solid var(--border-color)', overflow: 'hidden' }}>
                    <div style={{ flex: 1, background: 'transparent' }} />
          ...
          {/* Additional Canvas Toggles */}
          <SettingsGroup>
            <SettingsRow 
              icon={Eye} label="Show Mini-Map" 
              description="A bird's eye view of your entire canvas."
...
const AILearningSection = ({ showToast }) => {
  ...
  const handleToggleKey = async (keyId, isActive) => {
    try { 
      // Exclusive activation: Deactivate all other keys locally for instant feedback
      if (isActive) {
  ...
  return (
    <div style={{ maxWidth: '640px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{
            ...
            {hasActiveCustomKey ? 'Personal' : 'TutorBoard'}
          </div>
        </div>
      </div>
      ...
      <SettingsGroup>
        <SettingsRow icon={Key} label="Use Custom API"
        ...
        <div style={{ marginTop: '12px' }}>
          <SettingsGroup>
            <SettingsRow icon={Brain} label="Model Override" borderBottom={false}
              description="Force a specific model, bypassing AI routing."
              rightElement={<RightInlineSelect value={preferences.modelOverride || ''} onChange={v => handleUpdatePref('modelOverride', v)}
                options={[
                  ...
                  ...Array.from(new Set(apiKeys.map(k => k.model))).filter(m => m && m.trim()).map(model => ({
                    value: model,
              ...
              <div style={{ ...cardSt, display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    <label style={{ fontSize: '10px', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.1em', display: 'block' }}>API Key</label>
                    <a 
                      href={newProvider === 'openai' ? 'https://platform.openai.com/api-keys' : 
                            newProvider === 'google' ? 'https://aistudio.google.com/app/apikey' : 
                            newProvider === 'anthropic' ? 'https://console.anthropic.com/settings/keys' : 
                            newProvider === 'deepseek' ? 'https://platform.deepseek.com/api_keys' : 
                            'https://openrouter.ai/keys'}
                      target="_blank" 
                      rel="noopener noreferrer"
                      style={{ fontSize: '10px', fontWeight: 600, color: '#007AFF', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '3px' }}
                    >
                ...
                {/* API Name */}
                <div>
                   <label style={{ fontSize: '10px', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '8px', display: 'block' }}>API Name / Label</label>
                   <input type="text" value={newLabel} onChange={e => setNewLabel(e.target.value)} placeholder={`${PROVIDER_INFO[newProvider]?.name} Key`}
              ...
              return (
                <motion.div
                  ...
                  style={{ 
                    ...
                    background: key.isActive ? 'var(--bg-tertiary)' : 'var(--bg-primary)',
                    cursor: 'pointer'
                  }}
                  onClick={() => !key.isActive && handleToggleKey(key.id, true)}
                >
                  {/* Key Header */}
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: '14px', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '1px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{key.label || PROVIDER_INFO[key.provider]?.name || key.provider}</div>
                     ...
                     <div style={{ display: 'flex', items: 'center', gap: '6px', flexShrink: 0 }}>
                      <div style={{ display: 'flex', gap: '6px', alignItems: 'center', marginRight: '4px' }}>
                        {key.isActive && (
                          <motion.div 
                            animate={{ scale: [1, 1.2, 1], opacity: [0.8, 1, 0.8] }}
                            transition={{ duration: 2, repeat: Infinity }}
                            style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981', boxShadow: '0 0 8px rgba(16,185,129,0.5)' }} 
                            title="Active API"
                          />
                        )}
                        {key.isLowCredits && (
                          <div style={{ padding: '2px 6px', borderRadius: '6px', background: 'rgba(234, 179, 8, 0.15)', display: 'flex', alignItems: 'center', gap: '3px' }} title="Low Credits">
                            <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#eab308' }} />
                            <span style={{ fontSize: '8px', color: '#eab308', fontWeight: 700, textTransform: 'uppercase' }}>Low</span>
                          </div>
                        )}
                        {(key.isExpired || !key.isValid) && (
                          <div style={{ display: 'flex', alignItems: 'center', gap: '3px', color: '#ef4444' }} title={key.isExpired ? "Expired Key" : "Invalid Key"}>
        ...
        <div style={{ marginTop: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '8px' }}>
            {Object.entries(healthData.health || {}).filter(([id]) => id !== 'custom').map(([id, h]) => {
              ...
              const stateIcon = h.state === 'CLOSED' ? '✅' : h.state === 'HALF_OPEN' ? '⚠️' : '❌';
              return (
...
const PrivacySection = ({ syncSettings }) => {
  ...
  const handleExport = async () => {
    try {
      ...
      rows.push(['Name', data.user?.name || 'User']);
      rows.push(['Email', data.user?.email || 'N/A']);
      rows.push([]);
  ...
  return (
    <div style={{ maxWidth: '640px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        padding: '20px', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '20px'
      }}>
        <div style={{
          width: '56px', height: '56px', borderRadius: '14px', background: 'var(--bg-primary)',
          display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
            <span style={{ fontSize: '14px', fontWeight: 600, color: 'var(--text-primary)' }}>Local Cache Usage</span>
            <span style={{ fontSize: '12px', fontWeight: 500, color: 'var(--text-secondary)' }}>
              {storageUsage.used > 1024 ? `${(storageUsage.used / 1024).toFixed(1)} MB` : `${storageUsage.used.toFixed(1)} KB`} used
            </span>
          </div>
          <div style={{ height: '6px', borderRadius: '3px', background: 'var(--bg-secondary)', overflow: 'hidden' }}>
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: `${Math.max(2, storageUsage.percent)}%` }}
              transition={{ duration: 1, ease: 'easeOut' }}
              style={{
                height: '100%', borderRadius: '3px',
                background: storageUsage.percent > 80 ? '#ef4444' : storageUsage.percent > 50 ? '#f59e0b' : '#34C759'
              }}
            />
          </div>
          <p style={{ fontSize: '12px', color: 'var(--text-tertiary)', marginTop: '8px', lineHeight: 1.4 }}>
            TutorBoard caches session history locally for offline access and faster loading. Keep your cloud sync enabled for permanent storage.
          </p>
        </div>
      </div>
      ...
      <SettingsGroup>
        <SettingsRow
          ...
          description="Automatically backup canvases and messages to your account."
          rightElement={<AppleToggle value={cloudSync} onChange={setCloudSync} />}
        />
        <SettingsRow
          icon={RotateCcw} label="Auto-Save Frequency"
          rightElement={
            <RightInlineSelect
              value={autoSaveFreq} onChange={setAutoSaveFreq}
              options={[
        ...
        />
        <SettingsRow
          icon={Download} label="Local Offline Archive" borderBottom={false}
          description="Keep a persistent copy of chats after sessions end."
      ...
      {token && !cloudSync && (
        <div style={{
          padding: '12px 16px', background: 'rgba(245,158,11,0.1)', border: '1px solid rgba(245,158,11,0.2)',
          borderRadius: '12px', color: '#b45309', fontSize: '13px', display: 'flex', alignItems: 'flex-start',
          gap: '12px', marginBottom: '24px'
        }}>
          <AlertTriangle size={18} style={{ flexShrink: 0, marginTop: '2px' }} />
          <div>
            <strong>Cloud Sync is deactivated.</strong> Your interactions are only saved locally in this browser. If you clear your cache, your progress will be lost permanently.
          </div>
        </div>
      )}
