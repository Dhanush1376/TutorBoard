...
const CanvasControls = ({ 
  ...
  return (
    <motion.div
      ...
      className="absolute bottom-6 right-6 z-50 flex items-center gap-1.5 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-2xl p-1.5 shadow-lg pointer-events-auto"
    >
      {/* Zoom Out */}
      <button
        onClick={onZoomOut}
