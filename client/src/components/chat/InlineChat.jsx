    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      {!isExpanded && messages.length === 0 && (
        <button
          ...
          className="flex items-center gap-2 mx-auto px-4 py-2 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-full text-xs font-normal text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)] transition-all"
        >
