...
export const PROVIDERS = [
  ...
  { id: 'nvidia',      name: 'NVIDIA NIM',        color: '#76b900', price: 3, defaultModel: 'meta/llama3-8b-instruct',              patterns: [/^nvapi-/],                                                               hint: 'nvapi-...', link: 'https://build.nvidia.com/explore' },
  { id: 'anyscale',    name: 'Anyscale',          color: '#00b4d8', price: 3, defaultModel: 'mistralai/Mistral-7B-Instruct-v0.1',     patterns: [/^esecret_/],                                                             hint: 'esecret_...', link: 'https://app.endpoints.anyscale.com/' },
