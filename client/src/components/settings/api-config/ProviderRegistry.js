...
export const PROVIDERS = [
  ...
  { id: 'groq',        name: 'Groq',              color: '#f55036', price: 0, defaultModel: 'llama-3.3-70b-versatile',                 patterns: [/^gsk_/],                                                                 hint: 'gsk_...', link: 'https://console.groq.com/keys' },
  { id: 'huggingface', name: 'Hugging Face',      color: '#ff9d00', price: 0, defaultModel: 'meta-llama/Llama-3-8b-chat-hf',          patterns: [/^hf_/],                                                                  hint: 'hf_...', link: 'https://huggingface.co/settings/tokens' },
  ...
  { id: 'together',    name: 'Together AI',       color: '#0070f3', price: 0, defaultModel: 'meta-llama/Llama-3-70b-chat-hf',         patterns: [/^[a-f0-9]{64}$/],                                                        hint: '64-char hex', link: 'https://api.together.xyz/settings/api-keys' },
  { id: 'cerebras',    name: 'Cerebras',          color: '#34d399', price: 0, defaultModel: 'llama3.1-70b',                          patterns: [/^csk-/],                                                                 hint: 'csk-...', link: 'https://cloud.cerebras.ai/' },
  { id: 'sambanova',   name: 'SambaNova',         color: '#ec4899', price: 0, defaultModel: 'Llama-3.1-405B-Instruct',                patterns: [/^[a-f0-9-]{36}$/],                                                       hint: 'UUID format', link: 'https://cloud.sambanova.ai/' },
  { id: 'novita',      name: 'Novita AI',         color: '#8b5cf6', price: 0, defaultModel: 'meta-llama/llama-3.1-70b-instruct',      patterns: [/^[a-f0-9-]{36}$/],                                                       hint: 'UUID format', link: 'https://novita.ai/settings/key' },
  ...
  { id: 'deepinfra',   name: 'Deep Infra',        color: '#0ea5e9', price: 1, defaultModel: 'meta-llama/Meta-Llama-3-70B-Instruct',   patterns: [/^[A-Za-z0-9_-]{24,40}$/],                                                hint: 'alphanumeric token', link: 'https://deepinfra.com/dash/api_keys' },
  { id: 'fireworks',   name: 'Fireworks AI',      color: '#ff4e1a', price: 1, defaultModel: 'accounts/fireworks/models/llama-v3p1-70b-instruct', patterns: [/^fw_/],                                                hint: 'fw_...', link: 'https://fireworks.ai/account/api-keys' },
  { id: 'perplexity',  name: 'Perplexity',        color: '#20808d', price: 1, defaultModel: 'llama-3.1-sonar-large-128k-online',      patterns: [/^pplx-/],                                                                hint: 'pplx-...', link: 'https://www.perplexity.ai/settings/api' },
  { id: 'lepton',      name: 'Lepton AI',         color: '#3b82f6', price: 1, defaultModel: 'llama3-70b',                             patterns: [/^[A-Za-z0-9]{32}$/],                                                     hint: '32-char token', link: 'https://www.lepton.ai/dashboard' },
  ...
  { id: 'cohere',      name: 'Cohere',            color: '#39594d', price: 2, defaultModel: 'command-r-plus',                         patterns: [/^[A-Za-z0-9]{40}$/, /^co-/],                                            hint: '40-char or co-...', link: 'https://dashboard.cohere.com/api-keys' },
  { id: 'xai',         name: 'xAI / Grok',        color: '#111111', price: 2, defaultModel: 'grok-beta',                              patterns: [/^xai-/],                                                                 hint: 'xai-...', link: 'https://console.x.ai/' },
  { id: 'replicate',   name: 'Replicate',         color: '#111827', price: 2, defaultModel: 'meta/llama-2-70b-chat',                  patterns: [/^r8_/],                                                                  hint: 'r8_...', link: 'https://replicate.com/account/api-tokens' },
  ...
  { id: 'nvidia',      name: 'NVIDIA NIM',        color: '#76b900', price: 3, defaultModel: 'nvidia/llama-3.1-nemotron-70b-instruct', patterns: [/^nvapi-/],                                                               hint: 'nvapi-...', link: 'https://build.nvidia.com/explore' },
  { id: 'anyscale',    name: 'Anyscale',          color: '#00b4d8', price: 3, defaultModel: 'meta-llama/Meta-Llama-3-70B-Instruct',   patterns: [/^esecret_/],                                                             hint: 'esecret_...', link: 'https://app.endpoints.anyscale.com/' },
  ...
  { id: 'upstage',     name: 'Upstage',           color: '#7c3aed', price: 1, defaultModel: 'solar-1-mini-chat',                      patterns: [/^up_/],                                                                 hint: 'up_...', link: 'https://console.upstage.ai/' },
  { id: 'ai21',        name: 'AI21 Labs',         color: '#6c3fb5', price: 2, defaultModel: 'jamba-1.5-large',                        patterns: [/^[a-zA-Z0-9]{28}$/],                                                     hint: '28-char token', link: 'https://studio.ai21.com/account/api-key' },
  ...
  { id: 'vllm',        name: 'vLLM',              color: '#34d399', price: 0, defaultModel: 'meta-llama/Llama-3-70b',                 patterns: [],                                                                        hint: 'OpenAI-compatible server', link: 'https://github.com/vllm-project/vllm' },
