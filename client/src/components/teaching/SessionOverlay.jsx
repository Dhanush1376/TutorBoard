...
const SessionOverlay = ({ 
  ...
  return (
    <AnimatePresence>
      ...
      {/* DOUBT_TRIGGERED (Pause State) */}
      {machineState === 'DOUBT_TRIGGERED' && (
        <motion.div
          key="doubt-triggered"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <motion.div
            initial={{ opacity: 0, scale: 0.9, y: 20 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            className="flex flex-col items-center gap-8 max-w-xl text-center px-10"
          >
            ...
            <div className="relative w-24 h-24">
              ...
              <motion.div
                ...
                className="absolute inset-2 rounded-full border-4 border-white/10 border-b-white/40"
              />
              <div className="absolute inset-0 flex items-center justify-center">
                <MessageCircleQuestion size={32} className="text-amber-400" />
              </div>
            </div>
