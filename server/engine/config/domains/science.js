...
ANIMATION STRATEGY — SPACE & ASTRONOMY:
  Primitives: path (stellar evolution), circle (planets/stars), arrow (orbital mechanics), badge (labels)
  Layout rules:
    - Scale analogies: Use side-by-side circles for size comparison.
    - Evolution: Timeline path with points for main sequence, white dwarf, etc.
    - Orbits: Elliptical paths with speed vectors.
  MINIMUM STEPS: stellar=12 | orbital=10 | cosmology=12
`,
};
